...
const Testimonials = () => {
  return (
    <div
      className="flex flex-col antialiased bg-grid-white/[0.05] items-center justify-center relative overflow-hidden py-10"
      style={{
        backgroundImage: `url(${bgImage})`,
      }}
    >
      <h1 className="text-6xl text-gray-800">Recent Visitor's</h1>
      <InfiniteMovingCards
        items={testimonials}
        direction="right"
        speed="slow"
